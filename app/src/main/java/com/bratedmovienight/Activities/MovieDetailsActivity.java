...
import com.bratedmovienight.Adapters.MovieHorizontalViewAdapter;
import com.bratedmovienight.Helpers.Constants;
import com.bratedmovienight.Helpers.DateHelper;
import com.bratedmovienight.Models.Genre;
...
public class MovieDetailsActivity extends AppCompatActivity {
    ...
    protected void saveMovie(){
        ...
        final MovieFirebase mf = new MovieFirebase(String.valueOf(movie.getId()), movie.getName(), movie.getPoster(),
                movie.getReleaseDate(), true, false, movie.getVoteAvg());
