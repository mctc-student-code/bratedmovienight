package com.bratedmovienight.Adapters;
...
import com.bratedmovienight.Activities.MovieDetailsActivity;
import com.bratedmovienight.Helpers.Constants;
import com.bratedmovienight.Helpers.DateHelper;
import com.bratedmovienight.Models.SearchResult;
...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.SearchResultViewHolder> {
    ...
    public void onBindViewHolder(SearchResultViewHolder holder, int position) {
        ...
        if (mSearchResults.get(position).getMediaType().equals("movie")) {
